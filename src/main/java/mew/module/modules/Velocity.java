        ...
        if (event.getType() == EventType.POST) {
            if (this.reverseFlag
                    ...
                    this.canDelay()
                            ...
                            || Mew.delayManager.getDelay() >= (long) this.delayTicks.getValue()
            )) {
                Mew.delayManager.setDelayState(false, DelayModules.VELOCITY);
                ...
                if (packet.getEntityID() == mc.thePlayer.getEntityId()) {
                    ...
                    if (this.mode.getValue() == 2
                        ...
                        if (this.delayChanceCounter >= 100) {
                            Mew.delayManager.setDelayState(true, DelayModules.VELOCITY);
