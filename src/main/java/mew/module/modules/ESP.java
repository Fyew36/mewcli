...
import mew.events.ResizeEvent;
import mew.mixin.IAccessorEntityRenderer;
...
import mew.util.shader.GlowShader;
import mew.util.shader.OutlineShader;
    ...
    private Color getEntityColor(EntityPlayer entityPlayer) {
        if (TeamUtil.isFriend(entityPlayer)) {
            ...
            switch (this.color.getValue()) {
                ...
                case 2:
                    int hudColor = ((HUD) Mew.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis()).getRGB();
