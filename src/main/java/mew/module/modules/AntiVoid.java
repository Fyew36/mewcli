...
import mew.events.PlayerUpdateEvent;
import mew.module.Module;
import mew.util.PlayerUtil;
import mew.util.RandomUtil;
...
public class AntiVoid extends Module {
    ...
    private void resetBlink() {
        Mew.blinkManager.setBlinkState(false, BlinkModules.ANTI_VOID);
        ...
        if (this.isEnabled()) {
            ...
            if (this.mode.getValue() == 0) {
                ...
                if (!this.wasInVoid && this.isInVoid && this.canUseAntiVoid()) {
                    ...
                    if (Mew.blinkManager.setBlinkState(true, BlinkModules.ANTI_VOID)) {
                        this.lastSafePosition = new double[]{mc.thePlayer.prevPosX, mc.thePlayer.prevPosY, mc.thePlayer.prevPosZ};
                    }
                }
                if (Mew.blinkManager.getBlinkingModule() == BlinkModules.ANTI_VOID
                        && this.lastSafePosition != null
