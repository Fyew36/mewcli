...
public class AimAssist extends Module {
    ...
    private boolean isInReach(EntityPlayer entityPlayer) {
        Reach reach = (Reach) Mew.moduleManager.modules.get(Reach.class);
    ...
    public void onPress(KeyEvent event) {
        if (event.getKey() == mc.gameSettings.keyBindAttack.getKeyCode() && !Mew.moduleManager.modules.get(AutoClicker.class).isEnabled()) {
            this.timer.reset();
        }
    }
}
