...
import mew.util.ItemUtil;
import mew.util.RenderUtil;
import mew.util.RotationUtil;
                ...
                case PRE:
                    ...
                    if ((!bedNuker.isEnabled() || !bedNuker.isReady())
                        ...
                        if (players.isEmpty()) {
                            ...
                            Vec3 eyePosition = Mew.lagManager.getLastPosition().addVector(0.0, height, 0.0);
                            ...
                            for (EntityPlayer player : players) {
                                ...
                                if (!(distance > (double) this.range.getValue())) {
                                    ...
                                    if (shouldLag) {
                                        ...
                                        Mew.lagManager.setDelay(this.tickIndex);
                                        this.hasTarget = true;
                                        return;
                                    }
                                }
                    ...
                    break;
                case POST:
                    Vec3 savedPosition = Mew.lagManager.getLastPosition();
