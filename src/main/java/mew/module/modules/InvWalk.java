...
import mew.mixin.IAccessorC0DPacketCloseWindow;
...
public class InvWalk extends Module {
    ...
    public void pressMovementKeys(boolean skipSneak) {
        ...
        if (Mew.moduleManager.modules.get(Sprint.class).isEnabled()) {
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (mc.currentScreen instanceof mew.ui.ClickGui && this.guiEnabled.getValue()) {
