...
public class TargetStrafe extends Module {
    ...
    private boolean canStrafe() {
        if (this.speedOnly.getValue()) {
            Speed speed = (Speed) Mew.moduleManager.modules.get(Speed.class);
            Fly fly = (Fly) Mew.moduleManager.modules.get(Fly.class);
            LongJump longJump = (LongJump) Mew.moduleManager.modules.get(LongJump.class);
    ...
    private Color getTargetColor(EntityLivingBase entityLivingBase) {
        ...
        switch (this.showTarget.getValue()) {
            ...
            case 2:
                int color = ((HUD) Mew.moduleManager.modules.get(HUD.class)).getColor(System.currentTimeMillis()).getRGB();
