package mew.accounts;

import com.google.gson.*;
import mew.accounts.auth.Account;
import mew.accounts.utils.Nan0EventRegister;
import mew.accounts.utils.SSLUtils;
...
public class AccountManager {
    ...
    private static final File file = new File(mc.mcDataDir, "mewcli.accounts.json");
            ...
            try {
                if (file.getParentFile().exists() || file.getParentFile().mkdirs()) {
                    if (file.createNewFile()) {
                        System.out.print("Successfully created mewcli.accounts.json!");
                    }
                }
            } catch (IOException e) {
                System.err.print("Couldn't create mewcli.accounts.json!");
            }
        }
    }
    ...
    public static void load() {
        ...
        try {
            ...
            System.err.print("Couldn't find mewcli.accounts.json!");
        }
    }
    ...
    public static void save() {
        try {
            ...
            System.err.print("Couldn't save mewcli.accounts.json!");
        }
    }
}
