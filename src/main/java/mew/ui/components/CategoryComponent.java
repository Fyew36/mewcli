...
import mew.ui.animation.ScrollOffsetAnimation;
import mew.ui.ClickGui;
import mew.ui.components.Component;
import mew.module.Module;
import mew.util.render.RenderUtils;
import mew.util.ColorUtil;
import mew.util.Timer;
import mew.util.font.Font;
import mew.util.font.Fonts;
...
public class CategoryComponent {
    ...
    public CategoryComponent(String category) {
        ...
        List<Module> mods = mew.Mew.moduleManager.getModulesByCategory().get(category);
        if (mods != null) {
            for (Module mod : mods) {
    ...
    public void reloadModules() {
        ...
        List<Module> mods = mew.Mew.moduleManager.getModulesByCategory().get(this.category);
        if (mods != null) {
            for (Module mod : mods) {
