...
import mew.accounts.AccountManager;
import mew.command.CommandManager;
import mew.command.commands.*;
import mew.config.Config;
import mew.event.EventManager;
import mew.management.*;
import mew.module.Module;
import mew.module.ModuleManager;
import mew.module.modules.*;
import mew.property.Property;
import mew.property.PropertyManager;
...
public class Mew {
    ...
    public void init() {
        ...
        try (InputStreamReader reader = new InputStreamReader(Objects.requireNonNull(Mew.class.getResourceAsStream("/version.json")), StandardCharsets.UTF_8)) {
