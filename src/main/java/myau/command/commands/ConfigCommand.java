            ...
            switch (sub) {
                ...
                case "list":
                    try {
                        ...
                        if (configs.length == 0) {
                            ChatUtil.sendFormatted(String.format("%sNo configs found (&o%s&r)&r", Myau.clientName, "./config/mewcli/"));
                        }
                        ...
                        ChatUtil.sendFormatted(String.format("%sFailed to read (&o%s&r)&r", Myau.clientName, "./config/mewcli/"));
                    }
                    return;
                case "f":
                case "folder":
                ...
                case "directory":
                    try {
                        ...
                        ChatUtil.sendFormatted(String.format("%sFailed to open (&o%s&r)&r", Myau.clientName, "./config/mewcli/"));
                    }
                    return;
                default:
